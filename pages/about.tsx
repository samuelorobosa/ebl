            ...
            <main>
                <Jumbotron classNames="jumbotron_about">
                    <div className="text-white text-center max-w-2xl mx-auto mt-36">
                        ...
                        <p>Our mission is to prepare the next generation for success in a rapidly evolving world by providing them with the skills and knowledge they need to thrive. Our training programs focus on three key areas: employability, business, and leadership. By equipping young people with these vital skills, we aim to help them build fulfilling careers, start successful businesses, and become effective leaders in their communities</p>
                    </div>

                    <Link href="/joinmasterclass" className="text-center bg-ebl-primary text-white w-72 py-1.5 mx-auto block mt-7 rounded-md">
                        Join Masterclass
                    </Link>
                </Jumbotron>
                <OurMission/>
